        ...
        GUC0: function(t, e, n) {
            t.exports = function(t) {
                ...
                function p(t, e, n) {
                    ...
                    (e.convertToAbsoluteUrls || i) && (o = w(o)), r && (o += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(r)))) + " */");
                    var a = new Blob([o], {
                            type: "text/css"
                        }),
                        s = t.href;
                ...
                var o = n(1),
                    ...
                    d = function(t, e, n) {
                        var r = e.text,
                            ...
                            d = e.className,
                            p = e.closeModal,
                            h = o.stringToNode(l.buttonMarkup),
                            m = h.querySelector("." + a),
                            b = a + "--" + t;
                        m.classList.add(b), d && (Array.isArray(d) ? d : d.split(" ")).filter((function(t) {
                            return t.length > 0
                        })).forEach((function(t) {
                            m.classList.add(t)
                        })), n && t === c.CONFIRM_KEY && m.classList.add(s), m.textContent = r;
                        var v = {};
                ...
                var o = n(5),
                    ...
                    k = function(t) {
                        t.closeOnEsc ? document.addEventListener("keyup", p) : document.removeEventListener("keyup", p), t.dangerMode ? b() : v(), w(), O(t.closeOnClickOutside), _(t.timer)
                    };
                e.default = k
            }, function(t, e, n) {
                "use strict";
        ...
        MOAC: function(t, e, n) {
            ...
            function m() {
                ...
                var v = Object.getPrototypeOf,
                    g = v && v(v(A([])));
                g && g !== e && n.call(g, i) && (b = g);
                var y = h.prototype = d.prototype = Object.create(b);
                ...
                function _(t, e) {
                    var n = e.method,
                        o = t.iterator[n];
                    if (void 0 === o) return e.delegate = null, "throw" === n && t.iterator.return && (e.method = "return", e.arg = void 0, _(t, e), "throw" === e.method) || "return" !== n && (e.method = "throw", e.arg = new TypeError("The iterator does not provide a '" + n + "' method")), f;
                ...
                return p.prototype = h, o(y, "constructor", {
                    value: h,
                    configurable: !0
                }), o(h, "constructor", {
                    value: p,
                    configurable: !0
                }), p.displayName = c(h, s, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                    ...
                    return this
                })), t.AsyncIterator = x, t.async = function(e, n, o, r, i) {
                    void 0 === i && (i = Promise);
                    var a = new x(l(e, n, o, r), i);
                    return t.isGeneratorFunction(n) ? a : a.next().then((function(t) {
                        return t.done ? t.value : a.next()
                    }))
                }, w(y), c(y, s, "Generator"), c(y, i, (function() {
                    return this
            ...
            var v = function(t) {
                ...
                function n() {
                    ...
                    return (t = e.call.apply(e, [this].concat(a))).state = {
                        ...
                        totalRoadAffected: 0,
                        netPlotArea: 0,
                        netPlotAreaCitizen: 0,
                        distCode: 0,
                        mandalCode: 0,
                        disableFileUpload: !1,
                        disablePlotSubmit: !1,
                        plotQstThroughSW: !1,
                        vicinityQstThroughSW: !1,
                        isSingleWindow: !1,
                        applicationID: !1,
                        propertyID: !1,
                        organizationType: ""
                    }, t.handleUpdateSWGlobally = function() {
                        var e = t.state,
                            n = e.heightInMeters,
                            o = e.plotArea,
                            r = e.plotQstThroughSW,
                            i = e.vicinityQstThroughSW;
                        e.applicationType;
                        n > 10 || o > 500 || r || i ? t.setState({
                            applicationType: "SW"
                        }) : t.updateAppType(n, o)
                    }, t.updateFloors = function() {
                        var e = Object(o.a)(m().mark((function e(n, o, r, i) {
                            return m().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return e.next = 2, t.updateAppType(i, t.state.plotArea);
                                    case 2:
                                        return e.next = 4, t.setState({
                                            floorsID: n,
                                            noOfFloors: o,
                                            foolrsType: r
                                        });
                    ...
                    }(), t.updateAppType = function() {
                        var e = Object(o.a)(m().mark((function e(n, o) {
                            var r;
                            return m().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return "SW" !== (r = t.state.applicationType) && (o <= 62.71 && n <= 7 && (r = "REG"), o > 62.71 && o <= 500 && n <= 7 && (r = "SC"), o > 50 && o <= 500 && n > 7 && n <= 10 && (r = "SCMOR"), (n > 10 || o > 500) && (r = "SW")), e.next = 4, t.setState({
                                            heightInMeters: n,
                                            plotArea: o,
                                            applicationType: r
                                        });
                                    case 4:
                                        localStorage.setItem("plot-area", parseFloat(o));
                                    case 5:
                                    case "end":
                                        return e.stop()
                                }
                    ...
                    }(), t.handleAlertForSW = Object(o.a)(m().mark((function e() {
                        return m().wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return e.abrupt("return", d()({
                                        text: "Based on your selection, your application will be processed through ".concat("GRAM_PANCHAYAT" === t.state.organizationType ? "GP" : "", " single window."),
                ...
                return Object(i.a)(n, [{
                    ...
                    value: function() {
                        var t = this,
                            ...
                            n = e.heightInMeters,
                            o = e.plotAreaAsDoc,
                            r = e.plotAreaOriginal,
                            i = e.plotArea,
                            a = e.plotAreaType,
                            s = e.netPlotAreaCitizen,
                            c = e.applicationType,
                            l = e.floorsID,
                            u = e.noOfFloors,
                            f = e.foolrsType,
                            d = e.distCode,
                            m = e.mandalCode,
                            b = e.disableFileUpload,
                            v = e.disablePlotSubmit,
                            g = e.totalBuiltupArea,
                            y = (e.plotQstThroughSW, e.vicinityQstThroughSW, e.bpCaseType),
                            w = e.applicationID,
                            x = e.propertyID,
                            O = e.organizationType;
                        return h(p.a.Provider, {
                            value: {
                                heightInMeters: n,
                                plotAreaAsDoc: o,
                                plotAreaOriginal: r,
                                netPlotAreaCitizen: s,
                                plotArea: i,
                                plotAreaType: a,
                                applicationType: c,
                                floorsID: l,
                                ...
                                propertyID: x,
                                organizationType: O,
                                handlePlotAreaType: function(e) {
                                    t.setState({
                                        plotAreaType: e
                                    })
                                },
                                updatePlotArea: function(e) {
                                    t.updateAppType(n, e)
                                },
                                updateVicinityQstThroughSW: function(e) {
                                    t.setState({
                                        vicinityQstThroughSW: e
                                    }, (function() {
                                        t.handleUpdateSWGlobally()
                                    }))
                                },
                                handlePlotAreaAsDoc: function(e) {
                                    t.setState({
                                        plotAreaAsDoc: e
                                    })
                                },
                                handlePlotArea: function(e) {
                                    t.setState({
                                        plotArea: e
                                    })
                                },
                                handleNoOfFloors: function(e) {
                                    t.setState({
                                        noOfFloors: e
                                    })
                                },
                                handleDistMandal: function(e, n) {
                                    t.setState({
                                        distCode: e,
                                        mandalCode: n
                                    })
                                },
                                handleDisablePlotSubmit: function(e) {
                                    t.setState({
                                        disablePlotSubmit: e
                                    })
                                },
                                handleAlertForSW: function() {
                                    return t.handleAlertForSW()
                                },
                                updateNetPlotAreaCitizen: function(e) {
                                    t.setState({
                                        netPlotAreaCitizen: e
                                    })
                                },
                                updatePlotAreaOriginal: function(e) {
                                    t.setState({
                                        plotAreaOriginal: e
                                    })
                                },
                                updateHeight: function(e) {
                                    var n = localStorage.getItem("plot-area");
                                    t.updateAppType(e, parseInt(n))
                                },
                                handleContextCaseType: function(e) {
                                    t.handleCaseType(e)
                                },
                                updateFloors: function(e, n, o, r) {
                                    t.updateFloors(e, n, o, r)
                                },
                                updateAppTypeToSW: function() {
                                    t.setState({
                                        applicationType: "SW",
                                        isSingleWindow: !0
                                    })
                                },
                                updateAppTypeToSW500: function() {
                                    t.setState({
                                        isSingleWindow: !0
                                    })
                                },
                                updateDisableFileUpload: function(e) {
                                    t.setState({
                                        disableFileUpload: e
                                    })
                                },
                                handleBpCaseType: function(e) {
                                    t.setState({
                                        bpCaseType: e
                                    })
                                },
                                updateApplicationID: function(e) {
                                    t.setState({
                                        applicationID: e
                                    })
                                },
                                updatePropertyID: function(e) {
                                    t.setState({
                                        propertyID: e
                                    })
                                },
                                updateTotalBuiltupArea: function(e) {
                                    t.setState({
                                        totalBuiltupArea: e
                                    })
                                },
                                updateOrganizationType: function(e) {
                                    t.setState({
                                        organizationType: e
                                    })
                                }
